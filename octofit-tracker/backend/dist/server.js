...
import { sampleActivities, sampleLeaderboard, sampleTeams, sampleUsers, sampleWorkouts, } from './data/sampleData.js';
const app = express();
...
function sendCollection(routeName, model, fallbackData) {
